    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="form-group has-feedback field-loginform-password required">
          <input onkeypress="capLock(event)" oninput="checkRepassword()" id="password" data-validation-engine="validate[required,minSize[8]]" name="password" autocomplete="off" type="password" class="form-control" placeholder="Password">
        ...
        <div class="row">
          ...
          <div class="col-xs-4">
            <button type="submit" name="submit" value="submit" id="btnSubmit" disabled class="btn btn-primary btn-block btn-flat">Register</button>
          </div>
        </div>
