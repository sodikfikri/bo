...
?>
<title>404 - The page you are access was not found</title>
<style type="text/css">
...
:root {
  ...
  --animation-sentence: 'What are you looking for, there is nothing here?';
...
@keyframes showText {
  ...
  99% {
    --animation-sentence: 'What are you looking for?';
    opacity: 0;
    visibility: hidden;
  }
  100% {
...
<div class="container">
  <h1>404</h1>
  <p>The page request was not found</p>
  <svg class="keyhole">
    <use href="#keyhole"/>
  </svg>
</div>
...
const animationDuration = parseInt(rootStyles.getPropertyValue("--animation-duration"))*10000;
