...
<head>
  ...
  <!-- Custom style -->
  <link rel="stylesheet" href="<?= base_url('asset/css/custom_style.css?v=0.1') ?>">
  <!-- iCheck -->
...
<div class="register-box" style="margin-top:7%">
  ...
  <div class="register-box-body">
    <h3 class="text-center">Root User</h3>
    <?= !empty($msg) ? $msg : '' ?>
    ...
    <?= form_open("",["id"=>"form-validation"]); ?>
      <div class="form-group has-feedback">
        <input value="<?= !empty($this->input->post("username")) ? $this->input->post("username") : '' ?>" onkeypress="capLock(event)" autofocus data-validation-engine="validate[required]" name="username" type="text" class="form-control" placeholder="Username">
  ...
  <div class="footer-logo">
    <div class="footer-developed-by">Developed By</div>
    ...
    <div class="footer-copyright"><strong>Copyright &copy; <?= createProductionDate(2020) ?> <a href="https://interactive.co.id" target="_blank" style="color:#003c8f">InterActive Technologies Corp</a>.</strong> <br>All rights
    reserved. <?= "v.".APP_VERSION ?></div>
  </div>
