...
class GetResponse
{
     ...
     * @return mixed
     */
     public function getContactsByCampaignId($email,$campaignId)
     {
         return $this->call('contacts?query[email]=' . $email . '&query[campaignId]=' . $campaignId);
     }
     /**
      * retrieve all forms
      * @param array $params
...
//     $this->key = '98ffc7511b2f89aaaffe09c794d3297b';
//   }
...
//
//  CURLOPT_USERAGENT => 'PHP GetResponse client 0.0.2',
// 			CURLOPT_HTTPHEADER => array('X-Auth-Token: api-key 98ffc7511b2f89aaaffe09c794d3297b', 'Content-Type: application/json'),
// 			));
...
//     return $response;
// 	}
//   public function accountpostman(){
//     $curl = curl_init();
//
//     curl_setopt_array($curl, array(
//       CURLOPT_URL => "https://api.getresponse.com/v3/accounts",
...
//         "x-auth-token: api-key 98ffc7511b2f89aaaffe09c794d3297b"
//       ),
//     ));
//
//     $response = curl_exec($curl);
