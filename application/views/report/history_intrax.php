      ...
      <div class="box-body">
        <table class="table table-hover" width="100%" id="history-log">
          <thead>
            ...
            <th class="text-center"><?= $this->gtrans->line("Attendance Timezone") ?></th>
