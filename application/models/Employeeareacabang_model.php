 ...
 *
 */
class Employeeareacabang_model extends CI_Model
{
  var $tableName= "tbemployeeareacabang";
  ...
  function insert($dataInsert,$inputAppid=null){
    ...
    if(!empty($appid)){
      ...
      */
      ...
      $dataInsert['employeeareacabang_date_create'] = $this->now;

      $this->db->insert($this->tableName,$dataInsert);
      $insertID = $this->db->insert_id();
      /*
      if(!empty($dataInsert['employee_area_id'])){
        $areaID     = $dataInsert['employee_area_id'];
        $employeeID = $dataInsert['employeeareacabang_employee_id'];
      ...
      if(!empty($dataInsert['employee_cabang_id'])){
        $cabangID   = $dataInsert['employee_cabang_id'];
        $employeeID = $dataInsert['employeeareacabang_employee_id'];
  ...
  */
  ...
  function setAreaCabangAuto($cabangID,$areaID,$inputAppid=null){
    ...
    if(!empty($appid)){
      ...
      $this->db->where("appid",$appid);
      $this->db->where("employee_cabang_id",$cabangID);
      $this->db->update($this->tableName,$dataUpdate);
    }
  }
