...
<div class="register-box" style="margin-top:5%">
  <div class="register-logo">
    <a href="<?= base_url() ?>"><img src="<?= base_url("asset/images/logo.png") ?>" width="170px"></a>
  </div>
  <div class="register-box-body">
    ...
    <?= form_open("register-auth-intrax",["id"=>"form-validation"]); ?>
      ...
      <div class="form-group">
        <input data-validation-engine="validate[required,custom[onlyNumber],minSize[6],maxSize[6]]" name="otp-code" id="otp-code" type="number" class="form-control" placeholder="Input OTP" style="font-size:24pt;text-align:center;height:auto">
      </div>
...
<script>
  ...
  countDown("<?= $expiredDate ?>","countdown");
  ...
  function submitOTP()
  {
    ...
    $.ajax({
      method : "POST",
      url    : url + "submitOTPRegister",
      data   : {id:id,otp:otp},
      success: function (res){
        if(res=="found"){
          alert("Submit OTP Success!");
          window.open(url+"login-intrax","_self");
